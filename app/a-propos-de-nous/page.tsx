...
const teamMembers = [
  {
    ...
    image: "/dagneaux.jpg", // Updated to use real image
    linkedin: "#",
  ...
  },
  {
    ...
    image: "/corns.png", // Updated to use real image
    linkedin: "#",
  ...
  },
  {
    name: "Christian Arfi",
    title: "Consultant Sénior",
    image: "/arfi.jpg", // Updated to use real image
    linkedin: "#",
  ...
  },
  {
    ...
    image: "/ayari.png", // Updated to use real image
    linkedin: "#",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-8 text-balance">
            Qui sommes-nous?
          </h1>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-surface">
        <div className="container mx-auto max-w-6xl">
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-12 text-center">
            Notre équipe
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {teamMembers.slice(0, 3).map((member, index) => (
              <div key={index} className="flex flex-col items-center text-center group">
                <div className="relative w-48 h-48 mb-4 rounded-full overflow-hidden bg-gray-200 transition-transform duration-300 group-hover:scale-105">
                  <img
                ...
                <h3 className="font-sans font-bold text-lg text-text mb-2">{member.name}</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
            <div className="grid md:grid-cols-[280px_1fr] gap-12 items-start">
              <div className="flex flex-col items-center text-center mx-auto">
                <div className="relative w-64 h-64 mb-6 rounded-full overflow-hidden bg-gray-200">
                  <img
                ...
                <h3 className="font-sans font-bold text-xl text-text mb-2">{teamMembers[3].name}</h3>
              ...
              <div className="flex items-center h-full">
                <p className="text-text leading-relaxed text-base md:text-lg">{teamMembers[3].bio}</p>
              </div>
            </div>
          </div>
        </div>
